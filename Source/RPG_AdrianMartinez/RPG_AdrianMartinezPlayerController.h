...
#include "RPG_AdrianMartinezPlayerController.generated.h"

/** Forward declaration to improve compiling times */
class UNiagaraSystem;

UCLASS()
class ARPG_AdrianMartinezPlayerController : public APlayerController
{
	GENERATED_BODY()

public:
	ARPG_AdrianMartinezPlayerController();
